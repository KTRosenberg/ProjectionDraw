...
namespace CT {
    ...
    public static class SplineUtils {
		...
		public const int DEFAULT_SEGMENTS_PER_KEY = 10;
		...
		public static List<Vector3> MakeSpline(List<Vector3> keys, int segmentsPerKey = DEFAULT_SEGMENTS_PER_KEY) {
		...
		public static Vector3 Nearest(List<Vector3> points, float t) {
			t = Mathf.Clamp(t, 0, 0.999f);
			if(points.Count < 1) {
				return Vector3.zero;
			}
